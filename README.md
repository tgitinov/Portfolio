...
| [Прогнозирование количества заказов](time_series_predict) | Построение модели машинного обучения на датасете временного ряда | *pandas numpy sklearn matplotlib.pyplot statsmodels LinearRegression DecisionTreeRegressor RandomForestRegressor* |